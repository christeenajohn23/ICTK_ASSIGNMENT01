...
function lvalidate()
{
    ...
    else if(psr.test(pswd.value)!="1")
    {
        ...
        window.alert("Password should include minimum 8 characters, one uppercase, one lower case and one number.");
...
function svalidate()
{
    ...
    {
        window.alert("Passwords doesn't match! Re-enter password.");
        return false;
    }
    else
    {
